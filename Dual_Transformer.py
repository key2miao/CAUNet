...
import torch
import numpy as np
#from signal_transformer import TransformerEncoderLayer
from improve_single_trans import TransformerEncoderLayer
import os
...
'''
trans = Dual_Transformer(64, 64, num_layers=2)
